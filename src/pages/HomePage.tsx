  ...
  const featuredConcerts = [
    {
      ...
      image: "https://hips.hearstapps.com/hmg-prod/images/taylor-swift-performs-onstage-during-the-taylor-swift-the-news-photo-1681860356.jpg?crop=1xw:0.99988xh;center,top&resize=980:*",
      date: "Dec 15, 2023",
    ...
    },
    {
      ...
      image: "https://www.billboard.com/wp-content/uploads/2023/08/Billie-Eilish-paris-2023-a-billboard-1548.jpg?w=942&h=623&crop=1",
      date: "Feb 10, 2024",
      venue: "United Center",
      city: "Chicago, IL",
      affinity: 92,
...
/>
                      ...
                      >
                        <div className="space-y-6">
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-white/80 uppercase tracking-widest text-sm">{concert.tagline}</span>
                          </div>

                          <h1 className="text-4xl md:text-6xl font-bold leading-tight">{concert.headline}</h1>

                          <p className="text-white/80 text-lg max-w-xl">{concert.description}</p>
                  ...
                  <div className="absolute bottom-8 left-8 md:left-16 flex items-center space-x-3">
                    <span className="text-white/80 text-xl font-medium">{String(index + 1).padStart(2, "0")}</span>
  ...
  <div className="container px-4 items-center justify-center">
    <div className="text-center mb-16">
      ...
      <h2 className="text-3xl md:text-5xl font-bold mb-6 text-gray-800">Featured Concerts</h2>
      <p className="text-gray-600 max-w-2xl mx-auto">
        Discover upcoming shows from your most-listened artists with exclusive early access
      </p>
    </div>
      ...
      <section className="py-20 bg-white justify-center items-center flex">
        <div className="container px-4 justify-center items-center">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-gray-800">How Queue Priority Works</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our algorithm analyzes your Spotify listening history to determine your genuine connection to artists.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Link your Spotify account to analyze your listening history and playlists.",
              },
              {
                icon: "⭐",
                title: "Get Your Affinity Score",
                description: "We calculate how much you genuinely listen to and love each artist.",
              },
              {
                icon: "🎟️",
                title: "Priority Queue Access",
                description: "Higher affinity scores get earlier access to purchase tickets when they go on sale.",
              },
            ].map((step, index) => (
              <motion.div
                key={index}
              ...
              >
                <Card className="bg-white border-purple-200 shadow-sm overflow-hidden group h-full">
                  ...
                  <CardContent className="p-8">
                    <div className="mb-6 p-4 rounded-full bg-purple-100 w-fit text-4xl">{step.icon}</div>
          ...
          >
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="text-center md:text-left">
                <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Ready to Get Priority Access?</h2>
